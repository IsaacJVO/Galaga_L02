...
{	
	...
	// Cache our sound effect SoundWave'/Game/TwinStick/Audio/TwinStickFire.TwinStickFire'
	// 
	...
	static ConstructorHelpers::FObjectFinder<USoundBase> FireAudio(TEXT("SoundWave'/Game/StarterContent/Audio/PACHECO.PACHECO'"));
...
void AGalaga_USFX_LAB02Pawn::DisplayGameOverMessage()
{
    ...
    // Mostrar el mensaje en una pantalla de game over en lugar de mostrarlo en la consola
    GEngine->AddOnScreenDebugMessage(-1, 3.f, FColor::Red, Message, true, FVector2D(19.0f, 19.0f));
    // Lógica para mostrar la pantalla de game over
...
void AGalaga_USFX_LAB02Pawn::ActivateSpeedBoost()
{
	MoveSpeed = 2000.0f;
	FireRate = 0.1f;
	GetWorld()->GetTimerManager().SetTimer(TimerHandle_SpeedBoostExpired, this, &AGalaga_USFX_LAB02Pawn::ResetSpeedAndFireRate, 5.0f, true);
